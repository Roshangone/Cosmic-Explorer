...
async function loadRoverPhotos() {
    ...
    try {
        ...
        roverContent.innerHTML = `<p class="text-red-400 text-center">Error loading photos:${error.message} Nasa has shutdown its services temporarily which is the reason for several APIs erroring out.</p>`;
    }
}
